...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Constellation.zoom'
        db.add_column('futures_constellation', 'zoom',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Constellation.zoom'
        db.delete_column('futures_constellation', 'zoom')
    ...
    models = {
        ...
        'futures.geosound': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'default_volume': ('django.db.models.fields.FloatField', [], {'default': '0.32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'z': ('django.db.models.fields.FloatField', [], {'default': '-5.42'})
        },
        'futures.userprofile': {
