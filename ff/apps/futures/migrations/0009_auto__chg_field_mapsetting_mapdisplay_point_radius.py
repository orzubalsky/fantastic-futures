...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MapSetting.mapdisplay_point_radius'
        db.alter_column(u'futures_mapsetting', 'mapdisplay_point_radius', self.gf('django.db.models.fields.IntegerField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'MapSetting.mapdisplay_point_radius'
        db.alter_column(u'futures_mapsetting', 'mapdisplay_point_radius', self.gf('django.db.models.fields.IntegerField')(max_length=2))
    ...
    models = {
        ...
        u'futures.geosound': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'default_volume': ('django.db.models.fields.FloatField', [], {'default': '0.23'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'z': ('django.db.models.fields.FloatField', [], {'default': '1.5'})
        },
