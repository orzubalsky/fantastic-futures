...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('futures_constellation', (
            ...
            ('rotation_x', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('rotation_y', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('rotation_z', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('futures', ['Constellation'])

        # Adding M2M table for field connections on 'Constellation'
        db.create_table('futures_constellation_connections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('constellation', models.ForeignKey(orm['futures.constellation'], null=False)),
            ('connection', models.ForeignKey(orm['futures.connection'], null=False))
        ))
        db.create_unique('futures_constellation_connections', ['constellation_id', 'connection_id'])

        # Adding model 'Connection'
        db.create_table('futures_connection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('sound_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sound_1', to=orm['futures.GeoSound'])),
            ('sound_1_volume', self.gf('django.db.models.fields.FloatField')(default=0.8)),
            ('sound_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sound_2', to=orm['futures.GeoSound'])),
            ('sound_2_volume', self.gf('django.db.models.fields.FloatField')(default=0.8)),
        ))
        db.send_create_signal('futures', ['Connection'])


    def backwards(self, orm):
        # Deleting model 'Constellation'
        db.delete_table('futures_constellation')

        # Removing M2M table for field connections on 'Constellation'
        db.delete_table('futures_constellation_connections')

        # Deleting model 'Connection'
        db.delete_table('futures_connection')
