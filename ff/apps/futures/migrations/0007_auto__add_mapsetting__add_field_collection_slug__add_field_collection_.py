...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MapSetting'
        db.create_table(u'futures_mapsetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('basemap', self.gf('django.db.models.fields.CharField')(default='dymaxion', max_length=20)),
            ('initial_bounds', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True)),
            ('zoom_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('mapdisplay_fill_color', self.gf('django.db.models.fields.CharField')(default='#000000', max_length=7, blank=True)),
            ('mapdisplay_fill_opacity', self.gf('django.db.models.fields.FloatField')(default=1.0, blank=True)),
            ('mapdisplay_stroke_color', self.gf('django.db.models.fields.CharField')(default='#000000', max_length=7, blank=True)),
            ('mapdisplay_stroke_opacity', self.gf('django.db.models.fields.FloatField')(default=1.0, blank=True)),
            ('mapdisplay_point_radius', self.gf('django.db.models.fields.IntegerField')(max_length=2, blank=True)),
            ('mapdisplay_size', self.gf('django.db.models.fields.IntegerField')(default=8, null=True, blank=True)),
        ))
        db.send_create_signal(u'futures', ['MapSetting'])

        # Adding field 'Collection.slug'
        db.add_column(u'futures_collection', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='a', max_length=120),
                      keep_default=False)

        # Adding field 'Collection.map_setting'
        db.add_column(u'futures_collection', 'map_setting',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['futures.MapSetting'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MapSetting'
        db.delete_table(u'futures_mapsetting')

        # Deleting field 'Collection.slug'
        db.delete_column(u'futures_collection', 'slug')

        # Deleting field 'Collection.map_setting'
        db.delete_column(u'futures_collection', 'map_setting_id')
    ...
    models = {
        ...
        u'futures.geosound': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'default_volume': ('django.db.models.fields.FloatField', [], {'default': '0.33'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'z': ('django.db.models.fields.FloatField', [], {'default': '3.86'})
        },
        u'futures.mapsetting': {
            ...
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mapdisplay_fill_color': ('django.db.models.fields.CharField', [], {'default': "'#000000'", 'max_length': '7', 'blank': 'True'}),
            ...
            'mapdisplay_stroke_color': ('django.db.models.fields.CharField', [], {'default': "'#000000'", 'max_length': '7', 'blank': 'True'}),
