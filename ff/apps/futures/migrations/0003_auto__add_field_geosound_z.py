...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeoSound.z'
        db.add_column('futures_geosound', 'z',
                      self.gf('django.db.models.fields.FloatField')(default=-4.974506146996825),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeoSound.z'
        db.delete_column('futures_geosound', 'z')
    ...
    models = {
        ...
        'futures.geosound': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'z': ('django.db.models.fields.FloatField', [], {'default': '-4.974506146996825'})
        },
        'futures.userprofile': {
